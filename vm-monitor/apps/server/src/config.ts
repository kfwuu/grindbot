...
export const CONFIG: Config = {
  ...
  firecracker_widget_grow: numNull(penv('FIRECRACKER_WIDGET_GROW')) ?? 6,
  firecracker_widget_min_width:
    numNull(penv('FIRECRACKER_WIDGET_MIN_WIDTH')) ?? 500,
  firecracker_poll_interval:
    numNull(penv('FIRECRACKER_POLL_INTERVAL')) ?? 3000,
