...
import getFirecrackerInfo from './data/firecracker';
...
export const getDynamicServerInfo = () => {
  ...
  const fireCrackerObs = new LazyObservable(
    'Firecracker',
    CONFIG.widget_list.includes('firecracker'),
    runInBackground,
    1,
    CONFIG.firecracker_poll_interval,
    getFirecrackerInfo.dynamic,
  );
