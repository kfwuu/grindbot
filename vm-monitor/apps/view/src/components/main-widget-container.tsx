...
import { FirecrackerWidget } from '../widgets/firecracker';
...
export const MainWidgetContainer: FC = () => {
  ...
  const configs = {
    ...
    firecracker: {
      grow: config.firecracker_widget_grow,
      minWidth: config.firecracker_widget_min_width,
      Widget: FirecrackerWidget,
      data: undefined,
      load: fireCrackerLoad,
    },
  };
